...
class MatrixVectorizer:
    ...
    def vectorize(matrix, include_diagonal=False):
        ...
        """
        print(f"Vectorizing matrix of shape: {matrix.shape}")
    ...
    def anti_vectorize(vector, matrix_size, include_diagonal=False):
        ...
        """
        # print(f"Devectorizing vector of length: {len(vector)} to size: {matrix_size}x{matrix_size}")
        ...
        # print(f"Devectorized to matrix shape: {matrix.shape}")
        return matrix
