...
def train(model, subjects_adj, subjects_labels, args, verbose=False):
    ...
    split_index = len(subjects_adj) - 40
    train_g, val_G = subjects_adj[:split_index], subjects_adj[split_index:]
    train_labels, val_labels = subjects_labels[:split_index], subjects_labels[split_index:]
